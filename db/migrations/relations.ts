...
import { appUser, doctorPatient, patient, doctorAssistant, appointment, labTest, labTestResult, medicalRecord, imagingTest, imagingTestImage, dosageDetail, prescriptionItem, drug, frequencyDetail, prescription, vitalSign, documentType, role, disease, medicalRecordDisease, insuranceCompany, patientInsurance, userInsuranceAffiliateCode } from "./schema";
